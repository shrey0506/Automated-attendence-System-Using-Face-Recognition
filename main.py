...
window.title("KIIT Attendence System")
dialog_title = 'QUIT'
...
message = tk.Label(window, text="Kalinga Institute of Industrial Technology,\n Bhubaneswar Odisha ~751024" ,bg="white"  ,fg="green"  ,width=50  ,height=3,font=('times', 30, 'italic bold ')) 
message.place(x=70, y=20)
lbl = tk.Label(window, text="Roll No",width=20  ,height=2  ,fg="black"  ,bg="white" ,font=('times', 15, ' bold ') ) 
lbl.place(x=100, y=200)
txt = tk.Entry(window,width=20  ,bg="white" ,fg="black",font=('times', 15, ' bold '))
txt.place(x=500, y=215)
lbl2 = tk.Label(window, text="Enter Name",width=20   ,bg="white" ,fg="black"    ,height=2 ,font=('times', 15, ' bold ')) 
lbl2.place(x=100, y=300)
txt2 = tk.Entry(window,width=20  ,bg="white"  ,fg="black",font=('times', 15, ' bold ')  )
txt2.place(x=500, y=315)
lbl3 = tk.Label(window, text="Notification : ",width=20  ,bg="white" ,fg="black"  ,height=2 ,font=('times', 15, ' bold  ')) 
...
def TakeImages():        
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        harcascadePath = "haarcascade_profileface.xml"
        ...
        res = "Images for ID : " + Id +" Name : "+ name
        row = [Id , name]
...
trainImg = tk.Button(window, text="Train", command=TrainImages  ,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=500, y=500)
trackImg = tk.Button(window, text="Check", command=TrackImages  ,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
